...
FOREIGN KEY (problem_category_code ) REFERENCES  tracking_software_problems.Problem_Category_Codes(problem_category_code ),FOREIGN KEY (assigned_to_staff_id ) REFERENCES  tracking_software_problems.Staff(staff_id ),FOREIGN KEY (problem_id ) REFERENCES  tracking_software_problems.Problems(problem_id ),FOREIGN KEY (problem_status_code ) REFERENCES  tracking_software_problems.Problem_Status_Codes(problem_status_code )
);
